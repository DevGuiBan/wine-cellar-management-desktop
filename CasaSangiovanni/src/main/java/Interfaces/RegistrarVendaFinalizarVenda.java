 ...
 * @author rafaj
 */
public class RegistrarVendaFinalizarVenda extends javax.swing.JFrame {

    /**
     * Creates new form CadastrarProduto
     */
    public RegistrarVendaFinalizarVenda() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Registrar Venda (Produto)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarVendaFinalizarVenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrarVendaFinalizarVenda().setVisible(true);
            }
        });
    }
